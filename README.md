...
If you haven't done so already; you can use this git repo here, ony works for ubuntu/debian, For fedora you will have to enable the non-free repos inside software and install the drivers from there.
